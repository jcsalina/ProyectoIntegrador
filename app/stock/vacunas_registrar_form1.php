...
if(!isset($_GET['id'])) {
    ...
    if (isset($_POST['registrar_form'])) {
        ...
        $stockvacuna_actualizar = $pdo->prepare("INSERT INTO stockvacuna (id_vacuna, cantidad, cantidad_total, lote, dosis, stock_actual, fecha_ingreso, fecha_expiracion)
                                                 VALUES (:id_vacuna, :cantidad, :cantidad_total, :lote, :dosis, :stock_actual, :fecha_ingreso, :fecha_expiracion)");
...
?>
    ...
    <form id="editform" class="col-sm-12" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" name="editform">
        ...
        <div class="col-sm-6 form-group">
            ...
            <input type="number" name="dosis" id="dosis" class="form-control" placeholder="Ingrese dosis" value="">
            <span class="text-danger validation-error"><?php if (isset($dosis_error)) echo $dosis_error; ?></span>
        </div>
        <div class="col-sm-6 form-group">
