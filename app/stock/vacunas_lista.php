                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-bd lobidrag">
                            <div class="panel-heading">
                                <div class="btn-group">
                                    <a class="btn btn-success" href="vacunas_registrar.php"> <i class="fa fa-plus"></i> Nueva Vacuna</a>
                                </div>
                            </div>
                            <?php
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                                include "../../pdo/procesos/stock/vacuna/listar.php";
                                            ?>
