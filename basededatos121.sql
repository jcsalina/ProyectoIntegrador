...
-- Volcando datos para la tabla proyectoministerio.agendamiento: ~31 rows (aproximadamente)
/*!40000 ALTER TABLE `agendamiento` DISABLE KEYS */;
REPLACE INTO `agendamiento` (`id`, `paciente_id`, `fecha_cita`, `estado`) VALUES
	(1, 1, '2018-12-26 00:00:00', 'Agendada'),
	...
	(47, 30, '2019-03-03 00:00:00', 'Agendada'),
	(48, 4, '2019-03-04 00:00:00', 'Agendada'),
	(49, 13, '2019-02-21 00:00:00', 'Agendada');
...
-- Volcando datos para la tabla proyectoministerio.campana: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `campana` DISABLE KEYS */;
REPLACE INTO `campana` (`id`, `nombre`, `fecha_inicio`, `fecha_fin`, `edad`, `estado`) VALUES
	(2, 'Influenza', '2019-01-18', '2019-02-28', 1, 1);
...
-- Volcando datos para la tabla proyectoministerio.control: ~34 rows (aproximadamente)
...
REPLACE INTO `control` (`id`, `paciente_id`, `BCG`, `HBO`, `rotavirus1`, `rotavirus2`, `pentavalente1`, `pentavalente2`, `pentavalente3`, `poliomielitis1`, `poliomielitis2`, `poliomielitis3`, `neumococo1`, `neumococo2`, `neumococo3`, `SR`, `SRP`, `varicela`, `FA`, `OPV`, `Influenza`) VALUES
	...
	(6, 4, '2019-01-29', NULL, '2019-01-02', '2019-02-04', '2019-01-15', NULL, '2019-01-28', NULL, '2019-01-29', NULL, '2019-01-29', NULL, '2019-02-04', '2019-01-30', '2019-01-30', '2018-06-12', '2019-01-30', '2019-01-30', NULL),
	...
	(31, 29, '2018-04-18', NULL, '2018-06-18', '2018-09-20', '2018-06-18', '2018-08-20', '2018-10-22', '2018-06-18', '2018-08-20', '2018-10-22', '2018-06-18', '2018-08-20', '2018-10-22', NULL, NULL, NULL, NULL, NULL, NULL),
	(38, 30, NULL, '2019-02-05', NULL, NULL, NULL, '2019-02-04', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(41, 31, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(42, 32, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(43, 33, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(44, 34, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Volcando datos para la tabla proyectoministerio.historial: ~107 rows (aproximadamente)
...
REPLACE INTO `historial` (`id`, `paciente_id`, `empleado_id`, `fecha`) VALUES
	...
	(104, 30, 2, '2019-02-04 16:29:38'),
	(105, 30, 2, '2019-02-04 16:29:38'),
	(106, 4, 2, '2019-02-05 20:13:54'),
	(107, 4, 2, '2019-02-05 20:13:54');
...
-- Volcando datos para la tabla proyectoministerio.insumo: ~3 rows (aproximadamente)
/*!40000 ALTER TABLE `insumo` DISABLE KEYS */;
REPLACE INTO `insumo` (`id`, `nombre`, `calibre`, `estado`) VALUES
	(9, 'Jeringa 25 g', '25', '1'),
	(10, 'Jeringa 23 g', '23', '1'),
	(13, 'jeringa 23 g x 100', '23', '1');
...
-- Volcando datos para la tabla proyectoministerio.paciente: ~34 rows (aproximadamente)
...
REPLACE INTO `paciente` (`id`, `cedula_persona`, `fecha_nacimiento`, `sexo_id`, `cedula_padre`, `nombre_padre`, `cedula_madre`, `nombre_madre`, `etnia_id`, `nacionalidad_id`, `captacion_id`, `estado`, `pertenencia_distrito`) VALUES
	...
	(29, '0962371498', '2018-04-15', 1, '', '', '09205410032', 'Johanna Vanegas', 6, 1, 1, '', 1),
	(30, '0962361341', '2018-04-11', 2, '', '', '0923943062', 'Diana Pena', 6, 1, 1, '', 1),
	(31, '0961914785', '2017-09-27', 1, '', '', '0930777271', 'Ana Huacon', 6, 1, 1, '', 1),
	(32, '0962336897', '2018-04-03', 1, '', '', '0929761104', 'Ronmy Sanchez', 6, 1, 1, '', 1),
	(33, '0962355293', '2018-04-09', 1, '', '', '1312759143', 'Hilda Velez', 6, 1, 1, '', 1),
	(34, '0962339727', '2018-04-03', 1, '', '', '0922046255', 'Elvira Mosquera', 6, 1, 1, '', 2);
...
-- Volcando datos para la tabla proyectoministerio.persona: ~46 rows (aproximadamente)
...
REPLACE INTO `persona` (`id`, `cedula`, `nombre`, `apellido`, `correo`, `direccion`, `telefono`) VALUES
	...
	(39, '0962371498', 'Jose Alejandro', 'Robles Vanegas', '', 'Martha de Roldos mz 308 v 15 ', '0000000000'),
	(40, '0962361341', 'Aitana Damarys', 'Montoya Pena', 'andrres@outlook.es', 'Colinas de La Alborada MZ 2352 SL 35', '0978691817'),
	(41, '0961914785', 'Byron Nabil', 'Mina Huacon', '', 'Colinas de Mapasinge mz 456 v 05', '5063253'),
	(42, '0962336897', 'Francis Ruben', 'Ortega Sanchez', '', 'Cdla. Juan Tanca Marengo MZ A V 3', '0968549204'),
	(43, '0962355293', 'Thiago Orley', 'Burgos Velez', '', 'Coop 26 de febrero mz 238 sl 2', '0981287005'),
	(44, '0962339727', 'Juan Pablo', 'Canizares Jalon', '', 'Martha de Roldos MZ 101 v 7', '3080467');
...
-- Volcando datos para la tabla proyectoministerio.stockinsumo: ~5 rows (aproximadamente)
...
REPLACE INTO `stockinsumo` (`id`, `lote`, `cantidad`, `fecha_ingreso`, `fecha_expiracion`, `id_insumo`) VALUES
	(1, 2, '300', '2019-01-02 00:00:00', '2019-03-18 00:00:00', 9),
	(5, 2, '300', '2019-01-02 00:00:00', '2019-03-18 00:00:00', 9),
	(6, 999, '999', '2019-02-06 00:00:00', '2019-02-21 00:00:00', 9),
	(7, 1234, '12', '2019-02-01 00:00:00', '2019-03-31 00:00:00', 9),
	(8, 100, '3456', '2018-12-04 00:00:00', '2019-03-31 00:00:00', 13);
...
-- Volcando datos para la tabla proyectoministerio.stockvacuna: ~10 rows (aproximadamente)
/*!40000 ALTER TABLE `stockvacuna` DISABLE KEYS */;
REPLACE INTO `stockvacuna` (`id`, `lote`, `cantidad`, `fecha_ingreso`, `fecha_expiracion`, `id_vacuna`, `dosis`, `Cantidad_total`, `stock_actual`) VALUES
	(1, '3456', '20', '2019-01-05 00:00:00', '2019-04-12 00:00:00', 8, 0, 20, 20),
	(2, '777', '555', '2019-02-01 00:00:00', '2019-02-28 00:00:00', 5, 1, 555, 555),
	(3, '111', '111', '2019-02-01 00:00:00', '2019-02-20 00:00:00', 5, 1, 111, 111),
	(4, '123455', '25', '2019-02-04 00:00:00', '2019-02-28 00:00:00', 4, 10, 250, 250),
	(5, '77777', '20', '2019-02-01 00:00:00', '2019-02-20 00:00:00', 3, 25, 500, 500),
	(6, '99999', '10', '2019-02-28 00:00:00', '2019-05-31 00:00:00', 7, 10, 100, 100),
	(7, '888888', '3', '2019-02-01 00:00:00', '2019-02-28 00:00:00', 12, 30, 90, 90),
	(8, '123455', '25', '2019-02-04 00:00:00', '2019-02-28 00:00:00', 4, 10, 250, 250),
	(9, '99999', '10', '2019-02-28 00:00:00', '2019-05-31 00:00:00', 7, 10, 100, 100),
	(10, '667788', '7', '2019-02-01 00:00:00', '2019-08-31 00:00:00', 14, 30, 210, 210);
...
-- Volcando datos para la tabla proyectoministerio.vacuna: ~13 rows (aproximadamente)
